...
const medicine_resolver_1 = require("./medicine.resolver");
...
PrescriptionModule = __decorate([
    common_1.Module({
        ...
        providers: [prescription_resolver_1.PrescriptionResolver, prescription_service_1.PrescriptionService, patient_resolver_1.PatientResolver, medicine_resolver_1.MedicineResolver]
    })
], PrescriptionModule);
